...
def main(event: func.EventGridEvent, miztProc: func.InputStream, outputBlob: func.Out[str], doc: func.Out[func.Document], context: func.Context) -> None:
    get_req_body = None
    body_blob_name = None
    recv_blob_name = None
    ...
    try:
        ...
        # Injest to CosmosDB
        doc.set(func.Document.from_json(json.dumps(_d)))
